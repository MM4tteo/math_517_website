...
Create a [Shiny App](https://shiny.rstudio.com/tutorial/written-tutorial/lesson1/) or (alternatively) an R Markdown report explaining your findings. The report should be self-contained and include all code necessary to reproduce your results. If you choose to create a Shiny App, please include a link to the app in your report.
