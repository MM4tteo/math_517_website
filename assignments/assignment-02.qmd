...
::: callout-note
Go to the [course GitHub organization](https://github.com/MATH-517) and locate the repo titled `ae-2-YOUR_GITHUB_USERNAME` to get started.
:::
...
* generate data from a Gaussian mixture $f$ (see @sec-GaussianMixture)
...
# random generation for a mixture of two normal distribution
...
# density evaluation for a mixture of two normal distribution
