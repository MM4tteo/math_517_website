...
2. Read the `README.md` file in your assignment repository and follow the instructions there. (duplicated there for your convenience):
    ...
    You will have to save a figure showing the data and the linear regression from your function like below, and modify the `README.md` file to add a table containing the coefficients of the linear regression model.