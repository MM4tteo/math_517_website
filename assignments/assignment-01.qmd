...
::: callout-note
Go to the [course GitHub organization](https://github.com/MATH-517) and locate the repo titled `ae-1-YOUR_GITHUB_USERNAME` to get started. If you cannot find the repository, clik on [this link](https://classroom.github.com/a/pWe9OpR6).
:::
