...
[Here](../ressources/week-02/mini-project-example.qmd) is an example of what your report could look like. The first step should be done individually. Then you can form groups of 2-3 and pick up the most interesting data set and do the rest. 
