...
::: callout-tip
I do not recommend using the Rstudio interface for git as it will be only useful when using Rstudio and does not allow very good git practices. Instead, I recommend using the terminal (accessible in the Rstudio visual editor) to interact with git.
:::
